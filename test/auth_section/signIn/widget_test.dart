...
//     testWidgets('navigates from create account to sign in screen',
...
//     });
//     testWidgets('navigates from sign in to create account  screen',
//         (WidgetTester tester) async {
//       await tester.pumpWidget(MaterialApp(
//         home: WelcomeScreen(),
//         navigatorObservers: [mockObserver],
...
//   group('form validation + submission notifications', () {
//     test('show notification if email is in use', () {});
//   });
// }
